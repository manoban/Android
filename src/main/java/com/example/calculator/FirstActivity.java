...
public class FirstActivity extends AppCompatActivity   implements View.OnClickListener {
    ...
    public boolean onOptionsItemSelected(@NonNull MenuItem item) {
        ...
        switch (item.getItemId()) {
            case R.id.jzzh:
                intent.setClass(FirstActivity.this,jzzh.class);
                startActivity(intent);
                break;
             case R.id.dwhs:
                 intent.setClass(FirstActivity.this,danwei.class);
                 startActivity(intent);
                 break;
            case R.id.tjhs:
                intent.setClass(FirstActivity.this,Volume.class);
                startActivity(intent);
                break;
            case R.id.help:
                intent.setClass(FirstActivity.this,help.class);
                startActivity(intent);
            default:
        }
        return true;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        FirstActivity.this.setRequestedOrientation(ActivityInfo.SCREEN_ORIENTATION_FULL_SENSOR);//横屏
